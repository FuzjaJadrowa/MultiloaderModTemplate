...
// build-obfuscated-neoforge.gradle.kts
// NeoForge build configuration file template for the Multi-Version setup.
// This script is dynamically loaded by Stonecutter for NeoForge target versions.
