...
/**
 * Configure publication settings for individual loader targets (Fabric, NeoForge, etc.)
 * in a multi-version setup.
 *
 * Each version target subproject calls this helper to configure their respective Modrinth/CurseForge uploads.
 */
...
/**
 * Ensures the root project has GitHub publishing configured exactly once, gathering
 * compiled artifacts from all version targets and generating a single aggregated release.
 */
private fun Project.configureRootGithubPublishing() {
    val configuredMarker = "template.publish.root_configured"
        ...
        github {
            ...
            repository.set(
                rootProject.providers.gradleProperty("publish.github.repository")
                    ...
                    .orElse("YourGitHubUsername/YourRepository") // Replace with actual repository path or set via gradle properties
            )
            commitish.set(
